<?php
	...
	*******************************************/
    ...
    $user_insert = "INSERT INTO create_account (name, email, password, mobile,gender) VALUES ('$username', '$email_address','$hash_pass','$mobi','$gend')";
...
extract($_REQUEST);
   if (isset($_POST["sign_in"])){    
    ...
    $spot_username = "SELECT * FROM create_account WHERE email = '$username_entered' LIMIT 1";
