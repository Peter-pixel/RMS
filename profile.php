...
if(isset($update))
{
$que="update create_account set name='$name',password='$pass',mobile='$mob' where email='$eid'";
     ...
     <form class="form-horizontal" method="post">
      ...
      <div class="form-group">
	   ...
	   <div class="btn btn-primary btn-group btn-group-justified">
                <a href="vacantrooms.php"><h4><font color="white">Back</font></h4></a>
            </div>
    </div>
